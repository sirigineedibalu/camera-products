export const SolutionBreifData = [
  ...
  },
  {
    ...
    l1: "Traffic movement and congestion",
    l2: "Accidents",
    l3: "Peak-hour crowding",
    l4: "Difficulties for pedestrians",
    l5: "Parking difficulties",
    l6: "Off-peak inadequacy of transport",
    l7: "",
    l8: "",
    r1: "Red light violation detection",
    r2: "Speed enforcement",
    r3: "Real-time traffic monitoring",
    r4: "Parking violation detection",
    r5: "Traffic signal control",
    overviewimage:
