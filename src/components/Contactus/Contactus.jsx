  ...
  return (
    <div className="Contact-us-main-container">
      <form className="query-form" onSubmit={handleSubmit}>
        <h4>Have queries, doubts or suggestions?</h4>
        <div className="query-form-sub-list">
          <div className="form-group">
            ...
            <div className="query-side-div">
              ...
              <label className="select-label-container">Query Type:</label>
              <select
                id="select-option"
                name="queryType"
              ...
              >
                ...
                <option value="Sales Inqiury">Sales Inqiury</option>
