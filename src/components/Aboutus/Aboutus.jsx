        ...
        <div className="about-div-con">
          ...
          <div className="about-first-0para">
            ...
            <span>
              ...
              them are capable of offering resolutions also ranging from lowest
              720P to the highest 4K.
            </span>
          </div>
          <div className="about-first-0para">
            ...
            <span>
              ...
              users can take advantage of the HD Analog PTZ Cameras that are
              multidirectional and zoom capable.
            </span>
          </div>
          <div className="about-first-0para">
            ...
            <span>
              ...
              such as the Premium Series, Quartz Series, Rapid Series and
              Velocity Series.
            </span>
          </div>
          <div className="about-first-0para">
            ...
            <span>
              ...
              Quient Series from 1 SATA to 16 SATA, Maestro Series and Velocity
              Series.
            </span>
          </div>
          <div className="about-first-0para">
            ...
            <span>
              ...
              management costs. They come in different sizes and
              functionalities.
            </span>
          </div>
          <div className="about-first-0para">
            ...
            <span>
              ...
              as investments for the future. Equipped to provide both audio and
              video door entry systems, the equipment is designed for more
              discretion and better privacy.
            </span>
          </div>
          <div className="about-first-0para">
            <h5 id="headingcolor">
            ...
            <span>
              Trinai’s range of AI devices comprise of Advanced Driver
              Assistance systems, AI Boxes, and the R-Watch. Adopting a rich
              interface, our mobile DVRs are sturdy, support several channels
              and can withstand most weather conditions.
            </span>
          </div>
          <div className="about-first-0para">
            ...
            <span>
              ...
              recognition, facial identification and even vascular pattern
              identification. These advanced devices can authenticate, record
              attendance, access control time, and a lot more.
            </span>
          </div>
          <div className="about-first-0para">
            ...
            <span>
              ...
              thousands of hours of content in just a heartbeat. While managing
              tons of data, our video storage solutions never lose access and
              come with fault-tolerant designs for greater availability. The
              system displays outstanding resilience with no real single point
              of failure.
            </span>
            <span>
              Besides the above, we also offer several accessories customized to
              every device installation.
            </span>
            <span>We are committed to excellence in surveillance systems.</span>
            <span>
              Trinai India is the brand logo of this leading CCTV Company
            </span>
          </div>
        </div>
      </div>
